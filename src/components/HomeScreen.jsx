                ...
                <div className="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <input type="number" value={round.roundData.temperature || ''} onChange={(e) => round.setRoundData({ ...round.roundData, temperature: e.target.value ? parseInt(e.target.value) : null })}
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-xl px-3 py-3 font-body text-white text-sm placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-emerald-400 transition disabled:opacity-50 text-center" />
                  </div>
                </div>
                {/* GPS / Manual buttons */}
                <div className="grid grid-cols-2 gap-3">
